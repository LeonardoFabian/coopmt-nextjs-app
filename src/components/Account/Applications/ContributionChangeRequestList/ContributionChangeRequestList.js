...
import styles from "./ContributionChangeRequestList.module.scss";
...
export function ContributionChangeRequestList() {
  const { user } = useAuth();
  ...
  return (
    <div className={styles.contributionChangeRequestList}>
      <div className={styles.header}>
        <h5 className={styles.title}>Solicitudes de Cambio de Aportes</h5>
