...
export function UserData() {
    ...
    const [showChildrensInput, setShowChildrensInput] = useState(user.hasChildren);
    ...
    const formik = useFormik({
        ...
        onSubmit: async (formValues) => {
            let conditionalFormValues = {
                ...formValues,
                childrens: formValues.hasChildren === true ? formValues.childrens > 0 ? formValues.childrens : null : 0,
            }
            try {
        ...
        <Form className={styles.form} onSubmit={formik.handleSubmit}>
            ...
            <Form.Group>
                <Form.Field>
                    ...
                    <Button type='button' name="hasChildren" toggle active={userHasChildren} onClick={handleUserHasChildren} onChange={formik.handleChange} value={formik.values.hasChildren}>
                        {userHasChildren ? 'SI' : 'NO'}
                    </Button> */}
                    <Form.Select 
                        name="hasChildren"
                        label="Tienes hijos?"
